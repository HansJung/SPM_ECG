...
class Main:
    def __init__(self, record_idx, alpha, SDA_L1_penalty, SDA_L2_penalty,true_SVM, true_NN):
        ''' ECG label '''
        ...
        if true_NN:
            ...
            self.NN_accracy_dict = Evaluating_Performance_SVM_NN(NN_ans_dict,dict_test_label)
